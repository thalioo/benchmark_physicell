...
chemotaxis:
	cp ./unit_tests/chemotaxis/custom_modules/* ./custom_modules/
	touch main.cpp && cp main.cpp main-backup.cpp
	cp ./unit_tests/chemotaxis/main.cpp ./main.cpp 
	cp Makefile Makefile-backup
	cp ./unit_tests/chemotaxis/Makefile .
	cp ./config/PhysiCell_settings.xml ./config/PhysiCell_settings-backup.xml 
	cp ./unit_tests/chemotaxis/config/* ./config/
